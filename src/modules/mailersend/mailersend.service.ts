...
export class MailersendService {
  ...
  async sendMailAfterBooking(email: string, data: BookingConfirmationEmailDto) {
    ...
    sendSmtpEmail.subject = '🎉 Booking Confirmed - Hosteladmin.com';
          ...
          <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="background-color: #ffffff; border-radius: 8px; padding: 30px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
              <div style="text-align: center; margin-bottom: 30px;">
                ...
                <p style="font-size: 16px; color: #333;">Thank you for booking with <strong>Hosteladmin.com</strong>. We're excited to host you!</p>
              </div>
